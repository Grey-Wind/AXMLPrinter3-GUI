...
namespace AXmlColorBugFix
{
    public class Fix
    {
        ...
        public static async Task<string> FixColorBugAsync(string AXmlOutput)
        {
            return await RemoveFFAsync(AXmlOutput);
        }
        ...
        private static async Task<string> RemoveFFAsync(string xml)
        {
            // 正则表达式匹配android:fillColor属性中的#FF
            Regex regex = new(@"#FF");
